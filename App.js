...
function Sobre() {
  return(
    <View style={styles.section}>
      ...
      <Text>Fundada em 2025, temos o compromisso de trazer mais segurança..</Text>
    </View>
   );
}
...
function Serviços() {
  return(
  <View style={styles.section}>
      <Text style={styles.title}>Sobre Serviços</Text>
...
return (
  <View style={styles.section}>
   <Text style={styles.title}>Contato</Text>
    ...
    multiline
  />
  <TouchableOpacity styles={styles.button} onPress={enviar}>
